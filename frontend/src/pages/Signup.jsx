...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat overflow-hidden" style={{ backgroundImage: `url(${bgcloth})` }}>
      <div className="bg-transparent bg-opacity-50 p-6 sm:p-8 md:p-10 rounded-xl shadow-2xl w-full max-w-xs sm:max-w-sm md:max-w-md backdrop-blur-md">
        <h2 className="text-2xl sm:text-3xl font-bold text-orange-500 text-center mb-6 sm:mb-8">Join Cloth Store</h2>
